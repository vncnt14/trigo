    ...
    if (empty($username) || empty($password)) {
        ...
        if ($result) {
            if (mysqli_num_rows($result) == 1) {
                ...
                // Redirect to driverprofile.php
                echo "<script>alert('Login successful.'); window.location.href='driverprofile.php';</script>";
                exit();
            } else {
                echo "<script>alert('Invalid username or password. Register here if you don\\'t have an account.'); window.location.href='driverregistration.php';</script>";
            }
        } else {
...
<img src="dcc.png" alt="Your Image">
    ...
    <p>Don't have an account? <a href="driverregistration.php">Register here</a></p>
</body>
</body>
</html>
