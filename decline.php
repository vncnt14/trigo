...
$insert_query = "INSERT INTO b_dec (username, current_location, destination, km_value, fare_value, current_timedate, action)
                 VALUES ('{$booking['username']}', '{$booking['current_location']}', '{$booking['destination']}', 
                         '{$booking['km_value']}', '{$booking['fare_value']}', '{$booking['current_timedate']}', 'declined')";
